...
string
makeSkybox(AltitudeMap *hmap, int sh) {
	stringstream ret;
...
WATERCUBE
markAsWater(AltitudeMap *hmap, int x, int y, int from, int level, double max, WATERCUBE mvect) {
...
WATERCUBE
markAsWater(AltitudeMap *hmap, int x, int y, int level) {
...
string
makeWater(AltitudeMap *hmap, int sh) {
	stringstream ret;
...
string
makeGrid(AltitudeMap *hmap, int sh) {
	stringstream ret;
	int i, j;
	int w = hmap->xsize;
	int h = hmap->ysize;
